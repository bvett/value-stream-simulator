...
class TestToolchainPool(unittest.TestCase):
    ...
    def test_validation(self):
        ...
        _ = ResourcePool(class_name=Toolchain, limit=1)
        _ = ResourcePool(class_name=Toolchain, limit=None)

        # catch zero limit
        with self.assertRaises(ValueError):
            _ = ResourcePool(class_name=Toolchain, limit=0)
    ...
    def test_unlimited_iteration(self):
        ...
        toolchain_pool = ResourcePool(
            class_name=Toolchain, limit=None, deployment_duration=1)
