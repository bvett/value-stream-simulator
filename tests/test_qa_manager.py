...
class TestQAManager(unittest.TestCase):
    ...
    def _process_task(self, task: Task, m: Manager, t: Store):
        e = m.request()
    ...
    def _test_loop(self, m: Manager, t: Store):
    ...
    def test_serial(self):
        ...
        # 1 QA Tester, 2 Tasks
        manager = Manager(self.env, QATesterPool(limit=1))
    ...
    def test_parallel(self):
        ...
        manager = Manager(self.env, QATesterPool(limit=2))
        target = Store(self.env)
    ...
    def test_parallel_2(self):
        ...
        manager = Manager(self.env, QATesterPool())
        target = Store(self.env)
